...
func TestNewDNSProvider(t *testing.T) {
	testCases := []struct {
		...
		},
		{
			...
			expected: "conoha: some credentials information are missing: CONOHA_TENANT_ID,CONOHA_API_USER_ID,CONOHA_API_PASSWORD",
		},
		{
		...
		},
		{
			...
			expected: "conoha: some credentials information are missing: CONOHA_API_USER_ID",
		},
		{
