...
func TestNewDNSProvider(t *testing.T) {
	testCases := []struct {
		...
		},
		{
			...
			expected: "conohav3: some credentials information are missing: CONOHA_TENANT_ID,CONOHA_API_USER_ID,CONOHA_API_PASSWORD",
		},
		{
			...
			expected: "conohav3: some credentials information are missing: CONOHA_TENANT_ID",
		},
		{
			...
			expected: "conohav3: some credentials information are missing: CONOHA_API_USER_ID",
		},
		{
			...
			expected: "conohav3: some credentials information are missing: CONOHA_API_PASSWORD",
		},
	}
