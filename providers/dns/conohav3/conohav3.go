// Package conoha implements a DNS provider for solving the DNS-01 challenge using ConoHa VPS Ver 3.0 DNS.
package conohav3
...
// CONOHA_TENANT_ID, CONOHA_API_USER_ID, CONOHA_API_PASSWORD.
